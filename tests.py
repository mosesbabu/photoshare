...
class MyGalery_TestCases(TestCase):
    def setUp(self):
        self.new_category = Category(name='Dance')
        self.new_category.save_category()
        self.new_location = Location(location_name = 'Mombasa')
        self.new_location.save_location()
        self.new_image = Image(id=1,image_name='learn', image_description='Elephant',image_path='media/gallery/3134828_1920.jpg',image_category=self.new_category,image_location=self.new_location)
    ...
    def test_search_by_category(self):
        ...
        self.assertTrue(fetch_specific.ame=='Dance')
